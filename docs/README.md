...
| Document | Description |
|---|---|
| [api-docs.md](api-docs.md) | REST API reference — 50+ endpoints, request/response shapes, enums |
| [architecture.md](architecture.md) | System architecture — layered design, package layout, security, data flow |
| [env.md](env.md) | Environment variables and local setup |
| [contributing.md](contributing.md) | Contribution guidelines and conventions |

## Feature Notes

Slide-ready summaries in [features/](features/) for presentation to instructors.

| Note | Feature |
|---|---|
| [ai-slot-allocation.md](features/ai-slot-allocation.md) | AI scoring algorithm (RQ2-RQ4) |
| [monthly-pass.md](features/monthly-pass.md) | Monthly pass with free exit |
| [parking-session.md](features/parking-session.md) | Check-in/check-out lifecycle |
